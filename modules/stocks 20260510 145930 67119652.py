...
def _parse_fx(parts):
    """
    新浪外汇返回字段数不固定（3~11个），必须兼容。
    标准: [代码,时间,买价,卖价,最高,成交量,?, ?,最低,昨收,名称]
    极简: [代码,时间,最新,卖价]
    """
