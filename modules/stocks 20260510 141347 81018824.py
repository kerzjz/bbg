...
# ==================== 免费平替配置 ====================
# 股票/基金/指数/港股/美股  -> 新浪财经 + 腾讯财经 (无需Token)
# 期货                     -> AkShare 新浪期货接口
# 外汇                     -> 新浪财经实时外汇接口 (无需Token)
# 加密货币                 -> AkShare 金十数据实时 + CoinGecko K线
# =====================================================

# 可选导入：不玩期货/币圈可以不装 akshare
try:
...
FX_SINA_MAP = {
    # 兑人民币
    "USDCNY": "fx_susdcny", "EURCNY": "fx_seurcny", "GBPCNY": "fx_sgbpcny",
    "JPYCNY": "fx_sjpy100cny", "HKDCNY": "fx_shkdcny", "AUDCNY": "fx_saudcny",
    "CADCNY": "fx_scadcny", "SGDCNY": "fx_ssgdcny", "CHFCNY": "fx_schfcny",
    "NZDCNY": "fx_snzdcny", "KRWCNY": "fx_skrwcny", "RUBCNY": "fx_srubcny",
    "THBCNY": "fx_sthbcny",
    # 主要交叉盘
    "EURUSD": "fx_seurusd", "GBPUSD": "fx_sgbpusd", "USDJPY": "fx_susdjpy",
    "AUDUSD": "fx_saudusd", "USDCAD": "fx_susdcad", "USDCHF": "fx_susdchf",
    "NZDUSD": "fx_snzdusd", "EURGBP": "fx_seurgbp", "EURJPY": "fx_seurjpy",
    "GBPJPY": "fx_sgbpjpy", "AUDJPY": "fx_saudjpy", "CADJPY": "fx_scadjpy",
    "CHFJPY": "fx_schfjpy", "EURCHF": "fx_seurchf", "GBPCHF": "fx_sgbpchf",
    "EURAUD": "fx_seuraud", "GBPAUD": "fx_sgbpaud", "EURCAD": "fx_seurcad",
    "GBPCAD": "fx_sgbpcad", "AUDCAD": "fx_saudcad", "AUDCHF": "fx_saudchf",
    "NZDJPY": "fx_snzdjpy", "NZDCAD": "fx_snzdcad", "NZDCHF": "fx_snzdchf",
    "EURNZD": "fx_seurnzd", "GBPNZD": "fx_sgbpnzd", "AUDNZD": "fx_saudnzd",
}
...
def _parse_fx(parts):
    ...
    return {
        ...
        "chp": f"{chp}%",
        "v": "N/A",
        "t": f"{parts[11]} {parts[10]}" if len(parts) > 11 else str(parts[10]),
        "b": [{"p": parts[6], "v": "N/A"}],
        "a": [{"p": parts[7], "v": "N/A"}],
    }
